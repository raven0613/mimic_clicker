...
function createSummary(report: BalanceSimulationReport): string {
  ...
  return [
    ...
    `refill targets ${clearRefill.averageEffectiveTargetsBeforeRefill.toFixed(2)} → ${clearRefill.averageEffectiveTargetsAfterRefill.toFixed(2)} / shortage avg ${clearRefill.averageRefillTargetShortfall.toFixed(2)} p90 ${clearRefill.p90RefillTargetShortfall.toFixed(0)} / Jackpot chase ${clearRefill.jackpotChaseRefillCount}`,
